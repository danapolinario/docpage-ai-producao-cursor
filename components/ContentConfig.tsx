...
export const ContentConfig: React.FC<Props> = ({
  ...
  if (isLoading || !content) {
    return (
      <div className="max-w-6xl mx-auto bg-white p-12 rounded-xl shadow-lg border border-gray-100 min-h-[400px] flex flex-col items-center justify-center animate-fade-in relative overflow-hidden">
         {/* Background pulse */}
         ...
         <div className="relative z-10 flex flex-col items-center px-4">
            ...
            <div className="h-12 w-full text-center px-6">
               <p key={loadingStep} className="text-gray-600 font-small text-lg animate-slide-up break-words" style={{ overflowWrap: 'break-word' }}>

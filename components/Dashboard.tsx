    ...
    if (landingPageId) {
      try {
        ...
        await updateLandingPage(landingPageId, {
          content_data: updatedContent as any,
          section_visibility: key === 'testimonials' ? updatedVisibility : undefined, // Atualizar visibility se for depoimentos
        });
        ...
        if (dashboardData) {
          setDashboardData(prev => prev ? {
            ...
            landingPage: { 
              ...
              section_visibility: key === 'testimonials' ? updatedVisibility : prev.landingPage.section_visibility
            }
          } : prev);
        }
      } catch (err) {
          ...
          <nav className="flex-1 p-4 space-y-2 mt-4">
             ...
             <button 
               onClick={() => {
                 ...
                 setIsMobileMenuOpen(false);
                 setIsEditing(false); // Fechar editor se estiver aberto
               }}
            ...
            <div className="flex h-[calc(100vh-73px)]">
              <div className="w-80 flex-none border-r border-gray-200 bg-white">
                <EditorPanel
                  ...
                  hasCustomTestimonials={(localVisibility as any)?.hasCustomTestimonials}
                />
              </div>
            ...
            <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
             ...
             {activeView === 'overview' && !isLoading && !error && dashboardData && (
               <>
                 ...
                 {/* Aviso sobre depoimentos ilustrativos */}
                 {showTestimonialsWarning && (
                   <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 md:p-6 shadow-sm mb-6">
